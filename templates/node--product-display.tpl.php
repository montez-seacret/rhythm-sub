...
<?php }
    ...
    <div <?php print $content_attributes; ?>>
      ...
      <div class="row mb-60 mb-xs-30">
        ...
        <div class="col-md-4 mb-md-30">
          <?php print render($content['product:field_product_images']); ?>
          <br/>
          <strong id="share-product-text">Share product: </strong>
  ...
  <ul class="nav nav-tabs tpl-tabs animate">
      ...
      <li class="">
          <a href="#four" data-toggle="tab" aria-expanded="false">Video</a>
      </li>
       <?php endif; ?>
  </ul>
  ...
  <div class="tab-content tpl-tabs-cont">
    <div class="tab-pane fade active in" id="one">
      <?php print render($content['body']); ?>
      <p><?php print render($content['field_instructions']); ?></p>
      <?php if(isset($content['field_product_characteristics'])): ?>
        <p><strong>Charateristics:</strong><?php print render($content['field_product_characteristics']); ?></p>
      <?php endif; ?>
    </div>
    <?php if( isset($content['product:field_ingredients']) || isset($content['product:field_skin_type']) || isset($content['product:field_size']) ): ?>
      ...
      <table class="table table-bordered table-striped">
        <tbody>
          ...
          <?php if(isset($content['product:field_size'])): ?>
          <tr>
            <td>Size</td>
            <td><?php print render($content['product:field_size']); ?></td>
          </tr>
          <?php endif; ?>
          <?php if(isset($content['product:field_skin_type'])): ?>
          <tr>
            <td>Skin Type</td>
            <td><?php print render($content['product:field_skin_type']); ?></td>
          </tr>
          <?php endif; ?>
          <?php if(isset($content['product:field_ingredients'])): ?>
          <tr>
            <td>Ingredients</td>
